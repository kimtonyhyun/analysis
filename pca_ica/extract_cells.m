...
% Some parameters
mem_occup_scale_CPU = 0.5; % Occupy this x available memory on RAM
mem_occup_scale_GPU = 0.7; % Occupy this x available memory on GPU
corr_thresh = 0.1;
filter_thresh = 0.25;
max_num = 1000;
do_baseline_fix = 0;
...
if gpu_exists
    avail_mem = compute_available_memory(1);    
...
if use_gpu %GPU    
    ...
    avail_mem = compute_available_memory(0);
...
function avail_mem = compute_available_memory(is_GPU)
