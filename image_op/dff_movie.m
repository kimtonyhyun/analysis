function dff_movie(movie_in, movie_out)
...
%
% TODO: 
%   - Allow for F0 to be provided as an input to the function
%   - Explore F0 images that are not mean projections
%
...
F0_image = zeros(height, width, movie_type);
for i = 1:num_chunks
