...
if ~isfield(opts,'spat_medfilt_enabled'), opts.spat_medfilt_enabled=0; end
if ~isfield(opts,'spat_linfilt_enabled'), opts.spat_linfilt_enabled=0; end
...
if ~isfield(opts,'ss_max_num_sources'), opts.ss_max_num_sources =1000; end
